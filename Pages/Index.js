      ...
      <header className="flex items-center justify-between px-8 py-4 bg-[#12261c] sticky top-0 z-50 border-b border-[#d4af37]/30">
        ...
        <div className="flex gap-3">
          <a href={instagramLink} target="_blank">
            <Button className="bg-transparent border border-[#d4af37] text-[#d4af37] hover:bg-[#d4af37] hover:text-[#0f1f17]"><Instagram className="mr-2 h-4 w-4" /> Instagram</Button>
          </a>
          <a href={whatsappLink} target="_blank">
            <Button className="bg-[#7a1f2b] text-[#d4af37] hover:bg-[#5c1721]"><MessageCircle className="mr-2 h-4 w-4" /> WhatsApp</Button>
          </a>
        </div>
      </header>
      ...
      <section className="grid md:grid-cols-2 gap-10 px-8 py-20 items-center bg-gradient-to-b from-[#0f1f17] to-[#1b3326]">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div className="flex gap-4">
            <a href={whatsappLink} target="_blank">
              <Button size="lg" className="bg-[#7a1f2b] text-[#d4af37] hover:bg-[#5c1721]"><ShoppingBag className="mr-2 h-5 w-5" /> Order on WhatsApp</Button>
            </a>
            <a href="#collection">
